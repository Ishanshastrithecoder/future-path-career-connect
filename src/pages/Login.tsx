...
const Login = () => {
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: 'Failed to log in with Apple. Please try again.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
        ...
        <Card className="animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-xs text-careerblue-600 hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <Input
          ...
          <CardFooter className="flex justify-center">
            <p className="text-xs text-gray-600">
              ...
              <Link to="/register" className="text-careerblue-600 hover:underline">
                Sign up
              </Link>
            </p>
          </CardFooter>
